...
**Exercises:** Reimplement the following example as an anonynomous function
...
**Exercises:** Write a function called `load_data` that loads the carnivora data and creates a column2 with short name and very short name
