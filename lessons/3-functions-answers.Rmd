...
make_plot_year <- function(data, this_year) {
  data %>%
...
make_plot_year(data_gapminder, 1982) %>% print()

years <- unique(data_gapminder$year)

walk(years, ~make_plot_year(data_gapminder, .x) %>% print())
```
...
save_plot <- function(this_year, data_gapminder, path="output/by_year/") {
  ...
  make_plot_year(data_gapminder, this_year)
